...
function UploadModal({ isOpen, onClose }: UploadModalProps) {
    ...
    const {
        ...
        resetState,
    } = useUploadModalState({ preUploadAllImages, preserveQuality, isAdmin });
        ...
        <div className="upload-modal-overlay" onClick={handleCancel}>
            ...
            >
                ...
                <div className="upload-modal-content upload-modal-content--scrollable">
                    ...
                    {((!isAdmin && imagesData.length < 10) || isAdmin) && (
                        <div
                            ...
                            onClick={(e) => {
                                ...
                                input.onchange = (event) => {
                                    ...
                                    if (target.files && target.files.length > 0) {
                                        ...
                                        // Enforce limit only for non-admin users
                                        if (!isAdmin) {
                                            const maxImages = 10;
                                            ...
                                            if (newFiles.length > remainingSlots) {
                                                toast.warning(t('upload.maxImagesExceeded', { max: maxImages, selected: newFiles.length, added: remainingSlots }));
                                            }
