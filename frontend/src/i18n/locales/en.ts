...
export const en = {
  ...
  upload: {
    ...
    fileMustBeImageOrVideo: 'File must be an image or video',
    waitForAllUploads: 'Please wait for all images to finish uploading',
    uploadError: 'An error occurred while uploading images. Please try again.',
    allUploadedSuccess: 'All images uploaded successfully! You can submit now.',
    uploadFailed: 'Failed to upload images. Please try again.',
    someFilesRejected: 'Some files were rejected',
    geolocationNotSupported: 'Geolocation is not supported by this browser',
    cannotDetectLocation: 'Cannot detect location. Please enter manually.',
    autoDetectLocation: 'Auto-detect location',
    loading: 'Loading',
    maxImagesReached: 'Maximum {max} images allowed. Please remove some images before adding more.',
    maxImagesExceeded: 'You selected {selected} images, but only {added} were added (maximum {max} images allowed).',
  },
  ...
  search: {
    ...
    camera: 'Camera',
    cameraMake: 'Make (e.g., Canon)',
    cameraModel: 'Model (e.g., EOS R5)',
  ...
  admin: {
    ...
    activeUsers30Days: 'Active (30 days)',
    ...
    trendingImages: 'Trending Images (Last 7 Days)',
    ...
    websocketMetricsDescription: 'Real-time WebSocket connection and event statistics',
    activeConnections: 'Active Connections',
    activeConnectionsTooltip: 'Number of WebSocket connections currently active. Each user can have multiple connections (e.g., multiple browser tabs).',
    successRate: 'Success Rate',
    successRateTooltip: 'Percentage of successful connection attempts. Lower rates indicate authentication or network issues.',
    eventsPerSecond: 'Events/Second',
    eventsPerSecondTooltip: 'Average number of real-time events (notifications, updates, etc.) sent per second. Higher values indicate more activity.',
    avgLatency: 'Avg Latency',
    avgLatencyTooltip: 'Average time it takes to send an event from server to client. Lower is better. High latency indicates performance issues.',
    peakConnections: 'Peak Connections',
    peakConnectionsTooltip: 'Maximum number of concurrent connections reached since server start. Useful for capacity planning.',
    avgSessionDuration: 'Avg Session Duration',
    avgSessionDurationTooltip: 'Average time users stay connected. Longer durations indicate good user engagement and stable connections.',
    connectionRate: 'Connection Rate',
    connectionRateTooltip: 'Number of new connections established in the last minute. High rates indicate active user growth or frequent reconnections.',
    activeUsers: 'Active Users',
    activeUsersTooltip: 'Number of unique users currently connected. Different from connections (one user can have multiple tabs/connections). Also shows unique users in the last hour.',
    reconnectionRate: 'Reconnection Rate',
    reconnectionRateTooltip: 'Percentage of connections that were reconnections. High rates (>10%) indicate connection instability or network issues. Lower is better.',
    serverUptime: 'Server Uptime',
    serverUptimeTooltip: 'How long the WebSocket server has been running without restart. Longer uptime indicates system stability.',
    activeRooms: 'Active Rooms',
    activeRoomsTooltip: 'Number of active WebSocket rooms (groups). Rooms are created when users view images, collections, or profiles together for real-time updates.',
    eventDelivery: 'Event Delivery',
    eventDeliveryTooltip: 'Percentage of events successfully delivered to clients. Lower rates indicate network issues or client disconnections. Should be close to 100%.',
    estimatedBandwidth: 'Estimated Bandwidth',
    estimatedBandwidthTooltip: 'Estimated total data transferred via WebSocket events. Calculated as ~200 bytes per event. Useful for monitoring network usage.',
    connectionDurationDistribution: 'Connection Duration Distribution',
    connectionDurationDistributionTooltip: 'Distribution of how long users stay connected. Shows connection patterns - short sessions (0-1min) may indicate issues, while longer sessions (15min+) show good engagement.',
    topEventTypes: 'Top Event Types',
    topEventTypesTooltip: 'Most frequently sent event types. Shows which real-time features are most active (notifications, favorites, follows, etc.).',
    topRooms: 'Top Rooms',
    topRoomsTooltip: 'Rooms with the most concurrent users. Room IDs show which images, collections, or profiles are being viewed by multiple users simultaneously.',
    roomSizeDistribution: 'Room Size Distribution',
    roomSizeDistributionTooltip: 'Distribution of how many users are in each room. Shows if users typically view content alone (1 user) or together (multiple users). Higher counts indicate popular content.',
    errorBreakdown: 'Error Breakdown',
    errorBreakdownTooltip: 'Breakdown of errors by type: Authentication (invalid/expired tokens), Join (unauthorized room access attempts), Emit (failed event delivery), Other (miscellaneous errors). Monitor for patterns to identify issues.',
    systemHealth: 'System Health',
    systemHealthTooltip: 'Overall WebSocket system health score (0-100). Calculated from connection success (30%), event delivery (30%), error rate (20%), and latency (20%). Healthy: 75-100, Warning: 50-74, Critical: <50.',
    totalConnections: 'total connections',
    failedReconnected: '{failed} failed, {reconnected} reconnected',
    totalEvents: '{total} total events',
    minMaxLatency: 'Min: {min}, Max: {max}',
    maximumConcurrentConnections: 'Maximum concurrent connections',
    averageConnectionDuration: 'Average connection duration',
    connectionsPerMinute: 'Connections per minute',
    uniqueInLastHour: '{count} unique in last hour',
    reconnections: '{count} reconnections',
    runningSince: 'Running since {date}',
    totalUsersAcrossRooms: '{count} total users across all rooms',
    joinsLeaves: '{joins} joins, {leaves} leaves',
    deliveredFailed: '{delivered} delivered, {failed} failed',
    totalDataTransferred: 'Total data transferred (estimated)',
    howLongUsersStayConnected: 'How long users stay connected',
    mostFrequentlyEmittedEvents: 'Most frequently emitted events',
    roomsWithMostActiveUsers: 'Rooms with the most active users',
    averageRoomSize: 'Average room size: {size} users',
    ...
    noMetricsAvailableDescription: 'This may be because no WebSocket connections have been established yet.',
    errorLoadingMetrics: 'Error loading metrics',
    checkConsoleForDetails: 'Check browser console for more details.',
    healthy: 'HEALTHY',
    warning: 'WARNING',
    critical: 'CRITICAL',
  ...
  visualArtSlider: {
    ...
    noSlideData: 'No slide data available',
    definition: 'Definition',
    clickToSeeFullImage: 'CLICK TO SEE FULL IMAGE',
