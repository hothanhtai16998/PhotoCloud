...
export const vi = {
  ...
  image: {
    ...
    cameraMakeTooltip: 'Tên hãng sản xuất máy ảnh (ví dụ: Canon, Nikon, Sony, iPhone)',
    cameraModel: 'Model máy ảnh',
    cameraModelPlaceholder: 'Ví dụ: Canon EOS 7D',
    cameraModelTooltip: 'Tên model máy ảnh (ví dụ: Canon EOS 7D, iPhone X, Sony A7 III)',
